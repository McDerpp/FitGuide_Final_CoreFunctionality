...
class DatasetInfo(models.Model):
    ...
    positiveDatasetUrl = models.CharField(max_length=100)
    negativeDatasetUrl = models.CharField(max_length=100)
...
class UserTrainingInfo(models.Model):
    ...
    trainingInstanceKey = models.ForeignKey(
        TrainingInfo, on_delete=models.CASCADE)
