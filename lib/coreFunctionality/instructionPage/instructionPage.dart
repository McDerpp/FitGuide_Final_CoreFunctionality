...
import '../modes/collectionData.dart';
...
class _instructionPageState extends State<instructionPage> {
    ...
    return Align(
      ...
      child: Column(
        children: [
          ...
          instructionText(
              FontWeight.w600, 18, 15, 5, secondaryColor, "Step 5 (Submit!) :"),
          instructionText(FontWeight.w400, 12, 25, 2, tertiaryColor,
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.isInferencing == true) {
      ...
      renderInstruction = inferencingInstruction();
    } else {
      button = nextPageButton(
        "Get started",
        Colors.red,
      ...
      renderInstruction = dataCollectingInstruction();
    }
